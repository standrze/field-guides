...
|---|---|---|---:|
| LLM Training Field Guide — Tropical edition | gemma-cyber-training/ | <https://standrze.github.io/field-guides/gemma-cyber-training/> | 23 |
...
Increment its version in all seven index files whenever the shared layout changes.
